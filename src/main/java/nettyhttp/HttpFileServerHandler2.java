...
public class HttpFileServerHandler2 extends SimpleChannelInboundHandler<FullHttpRequest>{
    ...
    protected void messageReceived(ChannelHandlerContext ctx, FullHttpRequest request) throws Exception {
        ...
        final String path = santizeUri(uri);
//        final String path = "D:/codes/netty/nettylearn/" + uri;
        if (path == null) {
        ...
        try {
            randomAccessFile = new RandomAccessFile(file, "r");//只读方式
    ...
    private String santizeUri(String uri){
        try {
...
//        String result = System.getProperty("user.dir") + File.separator + uri;
        String result = "D:/codes/netty/nettylearn/" + uri;
